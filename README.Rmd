...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/srmatth/mshap.svg?token=zA4xhwrbzL7YLqiktuAB&branch=main)](https://travis-ci.com/srmatth/mshap)
[![Codecov test coverage](https://codecov.io/gh/srmatth/mshap/branch/main/graph/badge.svg)](https://codecov.io/gh/srmatth/mshap?branch=main)
<!-- badges: end -->
...
- If you use `{mshap}`, please cite [this article](https://www.google.com/)
